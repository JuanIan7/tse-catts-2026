  ...
  try {
    ...
    return <AppShell backHref="/app" backLabel="Minhas sessões" tone="immersive">
      <div className="dashboard">
        ...
        {!terminal && <VoiceConversation sessionId={session.id} lastCharacterTurn={lastCharacterTurn ? { id: lastCharacterTurn.id, pending: lastCharacterTurn.delivery_status === "PENDENTE" } : null} />}
