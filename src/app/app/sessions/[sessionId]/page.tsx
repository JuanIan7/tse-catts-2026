...
import { ScenarioMedia } from "@/components/scenario-media";
  ...
  try {
    ...
    return <AppShell backHref="/app" backLabel="Minhas sessões" tone="immersive">
      <div className="dashboard">
        ...
        <ScenarioMedia sessionId={session.id} briefing={briefing} locationUrl={locationSigned?.data?.signedUrl ?? null} characterUrl={characterSigned?.data?.signedUrl ?? null} />
