...
type Evaluation = { result: string; final_score: number; partial: boolean; calculation: { cobertura?: { avaliados: number; total: number; percentual: number }; rotulo?: string; aviso_parcial?: string | null; itens?: EvaluationItem[]; ficha_caso?: { fator_principal: string; fatores_risco: string[]; fatores_protecao: string[] }; acertos?: string[]; melhorias?: string[]; linha_evolucao?: { fala: string; observacao: string }[]; motivo_encerramento?: string; encerramento_forcado?: boolean; ocorrencias_graves?: number } };
