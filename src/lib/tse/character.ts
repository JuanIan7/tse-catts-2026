...
export async function respondAsCharacter(internalCase: InternalCase, transcript: TranscriptTurn[], didacticState: DidacticState): Promise<CharacterResponse> {
  ...
  const prompt = [
    ...
    "Responda em português natural com, no máximo, três frases curtas. O personagem pode estar retraído, defensivo ou irritadiço, conforme o perfil, mas sem ofensas direcionadas a grupos protegidos. Mantenha ambivalência até uma Saída Digna concreta, voluntária, imediata e aceita de forma inequívoca.",
